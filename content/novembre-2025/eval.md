...
- L'évaluation pour le cours de CI/CD sera un projet dédié par binome
- **But**: Ecrire une CLI (outil en ligne de commande) qui communique avec le vehicle-server pour
  - **1.**: Créér un véhicule
...
- Vous avez le choix du langage et du format du livrable
  ...
  - Un binaire aussi, ca sera testé sous Linux / x86_64 (si possible)
...
- Attention avec C++, je ne suis pas sur qu'il y aie des outils de gestion de dépendances.
